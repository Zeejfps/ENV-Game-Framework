...
layout(location = 2) in vec4 i_shapeData;        // line: p0.xy/p1.xy; circle: center.xy/radius
layout(location = 3) in float i_halfWidth;
layout(location = 4) in uint i_color;            // ARGB packed
layout(location = 5) in uint i_shapeType;        // 0 filled circle, 1 ring, 2 line/capsule
