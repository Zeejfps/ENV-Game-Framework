...
public interface IFilePicker
{
    ...
    /// user cancels or no picker exists. Opens at <paramref name="initialDirectory"/> when it is
    /// a real folder; ignored otherwise.
    /// </summary>
    void PickFolder(string title, string? initialDirectory, Action<string> onPicked);
