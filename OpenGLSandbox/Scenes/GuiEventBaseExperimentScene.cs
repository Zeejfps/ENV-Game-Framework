...
public sealed unsafe class BitmapFontTextRenderingSystem : GuiEventBaseExperimentScene.RenderingSystem<RenderedGlyphImpl>, ITextRenderingSystem
{
    ...
    private readonly string m_PathToFont;
        
    public BitmapFontTextRenderingSystem(IWindow window, string pathToFont)
    {
        m_Window = window;
        m_PathToFont = pathToFont;
    }
    ...
    public void Load()
    {
        ...
        var font = FontLoader.Load(m_PathToFont);
    ...
    public IRenderedText Create(Rect screenRect, TextStyle style, string text)
    {
        ...
        var textImpl = new GuiEventBaseExperimentScene.RenderedTextImpl(this, glyphs);
        return textImpl;
    }
